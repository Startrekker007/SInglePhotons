...
HD_PWD='D:/SInglePhotons/Vivado Projects/IODELAY_BLK/IODELAY_BLK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IODELAY_BLK_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IODELAY_BLK_wrapper.tcl
