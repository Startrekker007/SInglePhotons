...
HD_PWD='D:/SInglePhotons/Vivado Projects/DSCH_AXI_PERIPH/DSCH_AXI_PERIPH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSCH_AXI_PERIPH_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSCH_AXI_PERIPH_wrapper.tcl
