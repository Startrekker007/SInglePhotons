...
HD_PWD='D:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DD_TEST_OV_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DD_TEST_OV_wrapper.tcl -notrace
