...
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_axi_gpio_0_0/DD_AXI_PERIPH_axi_gpio_0_0_ooc.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_axi_gpio_0_0/DD_AXI_PERIPH_axi_gpio_0_0.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_axi_gpio_0_1/DD_AXI_PERIPH_axi_gpio_0_1_board.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_axi_gpio_0_1/DD_AXI_PERIPH_axi_gpio_0_1_ooc.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_axi_gpio_0_1/DD_AXI_PERIPH_axi_gpio_0_1.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_DD_DATA_0/DD_AXI_PERIPH_DD_DATA_0_board.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_DD_DATA_0/DD_AXI_PERIPH_DD_DATA_0_ooc.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_DD_DATA_0/DD_AXI_PERIPH_DD_DATA_0.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_DD_UTIL_0/DD_AXI_PERIPH_DD_UTIL_0_board.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_DD_UTIL_0/DD_AXI_PERIPH_DD_UTIL_0_ooc.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_DD_UTIL_0/DD_AXI_PERIPH_DD_UTIL_0.xdc}}]
set_property used_in_implementation false [get_files -all {{d:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/sources_1/bd/DD_TEST_OV/ip/DD_TEST_OV_DD_AXI_PERIPH_wrapper_0_2/src/DD_AXI_PERIPH_IODELAY_BLK_wrapper_0_1/src/IODELAY_BLK_ooc.xdc}}]
...
set_property used_in_implementation false [get_files {{D:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.srcs/constrs_1/new/PYNQ-Z1.xdc}}]
...
synth_design -top DD_TEST_OV_wrapper -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef DD_TEST_OV_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file DD_TEST_OV_wrapper_utilization_synth.rpt -pb DD_TEST_OV_wrapper_utilization_synth.pb"
