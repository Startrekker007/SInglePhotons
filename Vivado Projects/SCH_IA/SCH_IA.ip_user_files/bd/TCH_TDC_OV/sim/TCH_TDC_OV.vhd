...
architecture STRUCTURE of TCH_TDC_OV is
  ...
  component TCH_TDC_OV_D_REG_0_0 is
  port (
    CLK : in STD_LOGIC;
  ...
  end component TCH_TDC_OV_D_REG_0_0;
  component TCH_TDC_OV_T_META_HARDEN_0_0 is
  port (
    CLK : in STD_LOGIC;
    INP : in STD_LOGIC;
    S_OUT : out STD_LOGIC
  );
  end component TCH_TDC_OV_T_META_HARDEN_0_0;
  component TCH_TDC_OV_T_META_HARDEN_0_1 is
  port (
    CLK : in STD_LOGIC;
    INP : in STD_LOGIC;
    S_OUT : out STD_LOGIC
  );
  end component TCH_TDC_OV_T_META_HARDEN_0_1;
...
D_REG_0: component TCH_TDC_OV_D_REG_0_0
     port map (
...
T_META_HARDEN_0: component TCH_TDC_OV_T_META_HARDEN_0_0
     port map (
      CLK => clk_wiz_0_clk_out1,
      INP => M_RST_1,
      S_OUT => META_HARDEN_0_S_OUT
    );
T_META_HARDEN_1: component TCH_TDC_OV_T_META_HARDEN_0_1
     port map (
      CLK => clk_wiz_0_clk_out1,
      INP => CH0_1,
