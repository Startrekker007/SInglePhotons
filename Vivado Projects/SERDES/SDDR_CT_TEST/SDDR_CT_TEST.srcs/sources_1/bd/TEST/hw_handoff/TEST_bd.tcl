...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins selectio_wiz_0/clk_in] [get_bd_pins selectio_wiz_1/clk_in]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins SDDR_CT_0/MCLK] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins selectio_wiz_0/clk_div_in] [get_bd_pins selectio_wiz_1/clk_div_in]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins selectio_wiz_0/bitslip] [get_bd_pins selectio_wiz_1/bitslip] [get_bd_pins xlconstant_0/dout]
