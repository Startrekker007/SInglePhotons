...
################################################################
# This is a generated script based on design: PRG_IDELAY
#
...
# source PRG_IDELAY_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# IDELAY_BOI, IDELAY_BOI, IDELAY_CTRL_BOI
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set INPUT_PULSE [ create_bd_port -dir I INPUT_PULSE ]
  set OUT0 [ create_bd_port -dir O OUT0 ]
 ...
 ] [get_bd_pins /IDELAY_CTRL_BOI_0/RESET]
  ...
  # Create instance: del0, and set properties
  set del0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 del0 ]
  set_property -dict [ list \
  ...
  # Create instance: del1, and set properties
  set del1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 del1 ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_ALL_OUTPUTS_2 {0} \
   CONFIG.C_GPIO_WIDTH {5} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins del0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins del1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net IDELAY_BOI_0_OUTP [get_bd_ports OUT0] [get_bd_pins IDELAY_BOI_0/OUTP]
  connect_bd_net -net IDELAY_BOI_1_OUTP [get_bd_ports OUT1] [get_bd_pins IDELAY_BOI_1/OUTP]
  connect_bd_net -net IDELAY_CTRL_BOI_0_RDY [get_bd_ports RDY] [get_bd_pins IDELAY_CTRL_BOI_0/RDY]
  connect_bd_net -net Net [get_bd_ports INPUT_PULSE] [get_bd_pins IDELAY_BOI_0/INP] [get_bd_pins IDELAY_BOI_1/INP]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins IDELAY_BOI_0/TAP] [get_bd_pins del0/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins IDELAY_BOI_0/LCLK] [get_bd_pins IDELAY_BOI_1/LCLK] [get_bd_pins IDELAY_CTRL_BOI_0/REF_CLK] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net del1_gpio_io_o [get_bd_pins IDELAY_BOI_1/TAP] [get_bd_pins del1/gpio_io_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins del0/s_axi_aclk] [get_bd_pins del1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins del0/s_axi_aresetn] [get_bd_pins del1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins IDELAY_CTRL_BOI_0/RESET] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins IDELAY_BOI_0/LD] [get_bd_pins IDELAY_BOI_1/LD] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs del0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs del1/S_AXI/Reg] SEG_del1_Reg
