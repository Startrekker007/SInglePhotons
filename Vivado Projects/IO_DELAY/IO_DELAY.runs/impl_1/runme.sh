...
HD_PWD='D:/SInglePhotons/Vivado Projects/IO_DELAY/IO_DELAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PRG_IDELAY_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PRG_IDELAY_wrapper.tcl -notrace
