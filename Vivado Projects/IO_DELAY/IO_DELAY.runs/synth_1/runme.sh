...
HD_PWD='D:/SInglePhotons/Vivado Projects/IO_DELAY/IO_DELAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PRG_IDELAY_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PRG_IDELAY_wrapper.tcl
