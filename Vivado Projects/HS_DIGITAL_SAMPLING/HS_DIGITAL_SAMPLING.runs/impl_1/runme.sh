...
HD_PWD='C:/VivadoProj/HS_DIGITAL_SAMPLING/HS_DIGITAL_SAMPLING.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HS_SAMPLER_OVERLAY_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HS_SAMPLER_OVERLAY_wrapper.tcl -notrace
