...
#
# Generated by export_simulation on Tue Nov 26 13:10:09 +1300 2019
#
################################################################################
...
'-reset_run' switch to the './Counter_Overlay.sh' script.

./Counter_Overlay.sh -reset_run
...
./Counter_Overlay.sh -noclean_files

For more information on the script, please type './Counter_Overlay.sh -help'.
