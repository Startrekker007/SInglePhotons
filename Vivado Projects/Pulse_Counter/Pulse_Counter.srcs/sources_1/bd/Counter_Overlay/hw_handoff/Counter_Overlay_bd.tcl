...
################################################################
# This is a generated script based on design: Counter_Overlay
#
...
# source Counter_Overlay_script.tcl
...
set design_name Counter_Overlay
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set INPUT_PULSES [ create_bd_port -dir I -from 3 -to 0 INPUT_PULSES ]
  ...
  # Create instance: channel_sl_0, and set properties
  set channel_sl_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 channel_sl_0 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {4} \
  ...
  # Create instance: channel_sl_1, and set properties
  set channel_sl_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 channel_sl_1 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {4} \
  ...
  # Create instance: channel_sl_2, and set properties
  set channel_sl_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 channel_sl_2 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {2} \
   CONFIG.DIN_TO {2} \
   CONFIG.DIN_WIDTH {4} \
  ...
  # Create instance: channel_sl_3, and set properties
  set channel_sl_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 channel_sl_3 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {3} \
   CONFIG.DIN_TO {3} \
   CONFIG.DIN_WIDTH {4} \
  ...
  # Create instance: t_clk, and set properties
  set t_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 t_clk ]
  set_property -dict [ list \
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins CH_0/TCLK] [get_bd_pins CH_1/TCLK] [get_bd_pins CH_2/TCLK] [get_bd_pins CH_3/TCLK] [get_bd_pins c_clk/clk_in1] [get_bd_pins t_clk/clk_out1]
  ...
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins t_clk/clk_in1]
