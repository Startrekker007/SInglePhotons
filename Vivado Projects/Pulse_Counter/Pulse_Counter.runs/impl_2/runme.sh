...
HD_PWD='C:/Gitrep/SInglePhotons/Vivado Projects/Pulse_Counter/Pulse_Counter.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Counter_Overlay_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Counter_Overlay_wrapper.tcl -notrace
