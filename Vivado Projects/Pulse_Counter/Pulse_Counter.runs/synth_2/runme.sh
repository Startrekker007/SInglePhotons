...
HD_PWD='C:/Gitrep/SInglePhotons/Vivado Projects/Pulse_Counter/Pulse_Counter.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Counter_Overlay_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter_Overlay_wrapper.tcl
