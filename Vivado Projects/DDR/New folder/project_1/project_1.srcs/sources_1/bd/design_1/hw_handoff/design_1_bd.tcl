...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set CLK_H [ create_bd_port -dir I CLK_H ]
  ...
  set ttlisten [ create_bd_port -dir O ttlisten ]
  set ttwait [ create_bd_port -dir O ttwait ]
  ...
  connect_bd_net -net CLK_H_1 [get_bd_ports CLK_H] [get_bd_pins selectio_wiz_0/clk_in] [get_bd_pins selectio_wiz_1/clk_in] [get_bd_pins selectio_wiz_2/clk_in] [get_bd_pins selectio_wiz_3/clk_in] [get_bd_pins selectio_wiz_4/clk_in]
  connect_bd_net -net MCLK_1 [get_bd_ports MCLK] [get_bd_pins SDDR_TT_0/MCLK] [get_bd_pins selectio_wiz_0/clk_div_in] [get_bd_pins selectio_wiz_1/clk_div_in] [get_bd_pins selectio_wiz_2/clk_div_in] [get_bd_pins selectio_wiz_3/clk_div_in] [get_bd_pins selectio_wiz_4/clk_div_in]
  ...
  connect_bd_net -net SDDR_TT_0_ttlisten [get_bd_ports ttlisten] [get_bd_pins SDDR_TT_0/ttlisten]
  connect_bd_net -net SDDR_TT_0_ttwait [get_bd_ports ttwait] [get_bd_pins SDDR_TT_0/ttwait]
  ...
  connect_bd_net -net bitslip_1 [get_bd_ports bitslip] [get_bd_pins selectio_wiz_0/bitslip] [get_bd_pins selectio_wiz_1/bitslip] [get_bd_pins selectio_wiz_2/bitslip] [get_bd_pins selectio_wiz_3/bitslip] [get_bd_pins selectio_wiz_4/bitslip]
  connect_bd_net -net selectio_wiz_0_data_in_to_device [get_bd_pins SDDR_TT_0/DDR_T0] [get_bd_pins selectio_wiz_0/data_in_to_device]
  connect_bd_net -net selectio_wiz_1_data_in_to_device [get_bd_pins SDDR_TT_0/DDR_T1] [get_bd_pins selectio_wiz_1/data_in_to_device]
  connect_bd_net -net selectio_wiz_2_data_in_to_device [get_bd_pins SDDR_TT_0/DDR_T2] [get_bd_pins selectio_wiz_2/data_in_to_device]
  connect_bd_net -net selectio_wiz_3_data_in_to_device [get_bd_pins SDDR_TT_0/DDR_T3] [get_bd_pins selectio_wiz_3/data_in_to_device]
  connect_bd_net -net selectio_wiz_4_data_in_to_device [get_bd_pins SDDR_TT_0/DDR_T4] [get_bd_pins selectio_wiz_4/data_in_to_device]
