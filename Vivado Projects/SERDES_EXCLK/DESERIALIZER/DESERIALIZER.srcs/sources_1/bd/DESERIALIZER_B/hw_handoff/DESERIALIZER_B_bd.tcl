...
# module references:
# CLOCK_HD, DD_AXI_SLICE, DD_AXI_SLICE, DD_SPLITTER, IDELAY_WRAPPER, IDELAY_WRAPPER, IDELAY_WRAPPER, IDELAY_WRAPPER, IDELAY_WRAPPER, IDELAY_WRAPPER, ISERDES_B, ISERDES_B, ISERDES_B, ISERDES_B, ISERDES_B
...
proc create_root_design { parentCell } {
  ...
  # Create instance: CLOCK_HD_0, and set properties
  set block_name CLOCK_HD
  set block_cell_name CLOCK_HD_0
  if { [catch {set CLOCK_HD_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CLOCK_HD_0 eq "" } {
  ...
  connect_bd_net -net HS_CLK_1 [get_bd_pins CLOCK_HD_0/HS_CLK_O] [get_bd_pins ISERDES_B_0/clk_in] [get_bd_pins ISERDES_B_1/clk_in] [get_bd_pins ISERDES_B_2/clk_in] [get_bd_pins ISERDES_B_3/clk_in] [get_bd_pins ISERDES_B_4/clk_in]
  connect_bd_net -net HS_CLK_2 [get_bd_ports HS_CLK] [get_bd_pins CLOCK_HD_0/HS_CLK]
  ...
  connect_bd_net -net Net [get_bd_ports MCLK] [get_bd_pins CLOCK_HD_0/MCLK] [get_bd_pins ISERDES_B_0/clk_div_in] [get_bd_pins ISERDES_B_1/clk_div_in] [get_bd_pins ISERDES_B_2/clk_div_in] [get_bd_pins ISERDES_B_3/clk_div_in] [get_bd_pins ISERDES_B_4/clk_div_in]
