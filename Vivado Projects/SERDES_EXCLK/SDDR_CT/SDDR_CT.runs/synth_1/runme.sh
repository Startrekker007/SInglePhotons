...
HD_PWD='D:/SInglePhotons/Vivado Projects/SERDES/SDDR_CT/SDDR_CT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SDDR_CT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SDDR_CT.tcl
