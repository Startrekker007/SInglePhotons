...
proc create_root_design { parentCell } {
  ...
  set CLK_OUT [ create_bd_port -dir O -from 0 -to 0 CLK_OUT ]
  ...
  connect_bd_net -net Net [get_bd_ports RST] [get_bd_pins clk_wiz_0/reset] [get_bd_pins selectio_wiz_0/io_reset]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins selectio_wiz_0/clk_in]
  connect_bd_net -net selectio_wiz_0_data_out_to_pins [get_bd_ports CLK_OUT] [get_bd_pins selectio_wiz_0/data_out_to_pins]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins selectio_wiz_0/data_out_from_device] [get_bd_pins xlconstant_0/dout]
