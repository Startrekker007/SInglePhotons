...
HD_PWD='D:/SInglePhotons/Vivado Projects/SERDES_EXCLK/TOP_OVERLAY/TOP_OVERLAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SP_OV_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SP_OV_wrapper.tcl
