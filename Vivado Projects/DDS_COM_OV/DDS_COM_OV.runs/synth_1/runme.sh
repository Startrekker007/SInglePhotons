...
HD_PWD='D:/SInglePhotons/Vivado Projects/DDS_COM_OV/DDS_COM_OV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_COM_OV_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDS_COM_OV_wrapper.tcl
