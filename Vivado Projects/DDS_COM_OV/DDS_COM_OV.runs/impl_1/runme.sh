...
HD_PWD='D:/SInglePhotons/Vivado Projects/DDS_COM_OV/DDS_COM_OV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_COM_OV_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDS_COM_OV_wrapper.tcl -notrace
