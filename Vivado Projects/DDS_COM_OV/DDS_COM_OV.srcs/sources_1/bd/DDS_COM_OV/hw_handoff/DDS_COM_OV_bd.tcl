...
################################################################
# This is a generated script based on design: DDS_COM_OV
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {132.994} \
   CONFIG.CLKOUT1_PHASE_ERROR {186.953} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {464.000} \
  ...
  # Create instance: split_c_0, and set properties
  set block_name split_c
  set block_cell_name split_c_0
  if { [catch {set split_c_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net DDS_COM_wrapper_0_sig_out [get_bd_ports ch0] [get_bd_pins DDS_COM_wrapper_0/sig_out]
  connect_bd_net -net DDS_COM_wrapper_0_sig_out1 [get_bd_ports ch1] [get_bd_pins DDS_COM_wrapper_0/sig_out1]
  ...
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins axi_gpio_1/gpio2_io_o] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins split_c_0/inp]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins DDS_COM_wrapper_0/clk] [get_bd_pins clk_wiz_0/clk_out1]
  ...
  connect_bd_net -net split_c_0_out0 [get_bd_pins DDS_COM_wrapper_0/rst] [get_bd_pins split_c_0/out0]
  connect_bd_net -net split_c_0_out1 [get_bd_pins DDS_COM_wrapper_0/tval0] [get_bd_pins split_c_0/out1]
  connect_bd_net -net split_c_0_out2 [get_bd_pins DDS_COM_wrapper_0/tval1] [get_bd_pins split_c_0/out2]
