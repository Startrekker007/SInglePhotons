...
################################################################
# This is a generated script based on design: TCH_TDC_OV
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: CH0_EDGE, and set properties
  set block_name Edge_Detect
  set block_cell_name CH0_EDGE
  if { [catch {set CH0_EDGE [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: CH1_EDGE, and set properties
  set block_name Edge_Detect
  set block_cell_name CH1_EDGE
  if { [catch {set CH1_EDGE [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CH1_EDGE eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net CH0_EDGE_DET [get_bd_pins CH0_EDGE/DET] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins util_vector_logic_3/Op1]
  ...
  connect_bd_net -net Net [get_bd_ports M_RST] [get_bd_pins CH0_EDGE/O_RST] [get_bd_pins CH0_EDGE/RST] [get_bd_pins CH1_EDGE/O_RST] [get_bd_pins CH1_EDGE/RST] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net util_vector_logic_3_Res [get_bd_ports WAITING] [get_bd_pins c_counter_binary_0/CE] [get_bd_pins util_vector_logic_3/Res]
