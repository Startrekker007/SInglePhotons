...
simulate()
{
  xsim TEST -key {Behavioral:sim_1:Functional:TEST} -tclbatch cmd.tcl -protoinst "protoinst_files/SDDR_AXI_ST.protoinst" -protoinst "protoinst_files/TEST.protoinst" -log simulate.log
}
