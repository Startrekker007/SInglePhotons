...
HD_PWD='D:/SInglePhotons/Vivado Projects/Data_Transfer/TOP_OVERLAY/TOP_OVERLAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SP_OV_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SP_OV_wrapper.tcl -notrace
