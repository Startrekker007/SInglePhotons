...
entity CT_AXI_PERIPH_wrapper is
  port (
...
end CT_AXI_PERIPH_wrapper;

architecture STRUCTURE of CT_AXI_PERIPH_wrapper is
  component CT_AXI_PERIPH is
  port (
    ARMED : out STD_LOGIC_VECTOR ( 0 to 0 );
    WAITING : out STD_LOGIC_VECTOR ( 0 to 0 );
    data_araddr : in STD_LOGIC_VECTOR ( 8 downto 0 );
...
begin
CT_AXI_PERIPH_i: component CT_AXI_PERIPH
     port map (
      ARMED(0) => ARMED(0),
      CH0 => CH0,
      CH1 => CH1,
