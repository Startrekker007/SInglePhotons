...
HD_PWD='D:/SInglePhotons/Vivado Projects/PG_OVERLAY/PG_OVERLAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PG_OV_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PG_OV_wrapper.tcl -notrace
