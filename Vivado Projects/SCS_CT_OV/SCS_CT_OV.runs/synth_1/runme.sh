...
HD_PWD='D:/SInglePhotons/Vivado Projects/SCS_CT_OV/SCS_CT_OV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCS_CT_OV_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCS_CT_OV_wrapper.tcl
