...
HD_PWD='D:/SInglePhotons/Vivado Projects/TDC_SINGLE_CHANNEL/TDC_SINGLE_CHANNEL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TDC_OVERLAY_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TDC_OVERLAY_wrapper.tcl -notrace
