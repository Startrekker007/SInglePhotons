...
HD_PWD='D:/SInglePhotons/Vivado Projects/TDC_SINGLE_CHANNEL/TDC_SINGLE_CHANNEL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TDC_OVERLAY_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TDC_OVERLAY_wrapper.tcl
