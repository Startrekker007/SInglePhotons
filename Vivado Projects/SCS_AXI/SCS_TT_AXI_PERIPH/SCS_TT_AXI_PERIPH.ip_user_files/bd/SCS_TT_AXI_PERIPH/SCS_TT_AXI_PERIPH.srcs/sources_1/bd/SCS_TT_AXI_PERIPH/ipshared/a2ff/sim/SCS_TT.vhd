...
architecture STRUCTURE of SCS_TT is
  ...
  port (
    ...
    CH2 : in STD_LOGIC;
    CH3 : in STD_LOGIC;
    DELT : in STD_LOGIC_VECTOR ( 7 downto 0 );
    DEL0 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    DEL1 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    DEL2 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    DEL3 : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal CDELAY_T0_DLINE : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal TT_CDELAY_0_DLINE : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal TT_CDELAY_1_DLINE : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal TT_CDELAY_2_DLINE : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal TT_CDELAY_3_DLINE : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal TT_DETECTOR_0_ODEL2 : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal TT_DETECTOR_0_ODEL3 : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal TT_DETECTOR_0_ODELT : STD_LOGIC_VECTOR ( 7 downto 0 );
...
begin
  ...
  DEL3(7 downto 0) <= TT_DETECTOR_0_ODEL3(7 downto 0);
  DELT(7 downto 0) <= TT_DETECTOR_0_ODELT(7 downto 0);
...
CDELAY_T0: component SCS_TT_TT_CDELAY_2_1
     port map (
      DLINE(7 downto 0) => CDELAY_T0_DLINE(7 downto 0),
      IDATA => T0_1,
...
TT_CDELAY_0: component SCS_TT_TT_CDELAY_0_0
     port map (
      DLINE(7 downto 0) => TT_CDELAY_0_DLINE(7 downto 0),
      IDATA => CH0_1,
...
TT_CDELAY_1: component SCS_TT_TT_CDELAY_0_1
     port map (
      DLINE(7 downto 0) => TT_CDELAY_1_DLINE(7 downto 0),
      IDATA => CH1_1,
...
TT_CDELAY_2: component SCS_TT_TT_CDELAY_1_0
     port map (
      DLINE(7 downto 0) => TT_CDELAY_2_DLINE(7 downto 0),
      IDATA => CH2_1,
...
TT_CDELAY_3: component SCS_TT_TT_CDELAY_2_0
     port map (
      DLINE(7 downto 0) => TT_CDELAY_3_DLINE(7 downto 0),
      IDATA => CH3_1,
...
TT_DETECTOR_0: component SCS_TT_TT_DETECTOR_0_0
     port map (
      ...
      CH2 => CH2_1,
      CH3 => CH3_1,
      DEL0(7 downto 0) => TT_CDELAY_0_DLINE(7 downto 0),
      DEL1(7 downto 0) => TT_CDELAY_1_DLINE(7 downto 0),
      DEL2(7 downto 0) => TT_CDELAY_2_DLINE(7 downto 0),
      DEL3(7 downto 0) => TT_CDELAY_3_DLINE(7 downto 0),
      DELT(7 downto 0) => CDELAY_T0_DLINE(7 downto 0),
      DRDY => TT_DETECTOR_0_DRDY,
      MCLK => MCLK_1,
      ODEL0(7 downto 0) => TT_DETECTOR_0_ODEL0(7 downto 0),
      ODEL1(7 downto 0) => TT_DETECTOR_0_ODEL1(7 downto 0),
      ODEL2(7 downto 0) => TT_DETECTOR_0_ODEL2(7 downto 0),
      ODEL3(7 downto 0) => TT_DETECTOR_0_ODEL3(7 downto 0),
      ODELT(7 downto 0) => TT_DETECTOR_0_ODELT(7 downto 0),
      RESETN => resetn_1,
      T0 => T0_1,
      T1(31 downto 0) => TT_DETECTOR_0_T1(31 downto 0),
      T2(31 downto 0) => TT_DETECTOR_0_T2(31 downto 0),
