...
HD_PWD='D:/SInglePhotons/Vivado Projects/CO_AXI_PERIPH/CO_AXI_PERIPH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CO_AXI_PERIPH_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CO_AXI_PERIPH_wrapper.tcl
