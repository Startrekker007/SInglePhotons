...
HD_PWD='D:/SInglePhotons/Vivado Projects/EXPERIMENTAL/SCS_TT16/SCS_TT16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCS_TT_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCS_TT_wrapper.tcl
