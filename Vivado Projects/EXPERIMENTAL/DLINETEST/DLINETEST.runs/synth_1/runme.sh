...
HD_PWD='D:/SInglePhotons/Vivado Projects/EXPERIMENTAL/DLINETEST/DLINETEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdc_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tdc_ctrl.tcl
