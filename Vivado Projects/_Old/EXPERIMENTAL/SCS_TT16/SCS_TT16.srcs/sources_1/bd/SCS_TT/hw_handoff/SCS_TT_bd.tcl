...
proc create_root_design { parentCell } {
  ...
  set DEBUG0 [ create_bd_port -dir O -from 31 -to 0 DEBUG0 ]
  set DEBUG1 [ create_bd_port -dir O -from 31 -to 0 DEBUG1 ]
  set DEBUG2 [ create_bd_port -dir O -from 15 -to 0 DEBUG2 ]
  set DEL0 [ create_bd_port -dir O -from 7 -to 0 -type data DEL0 ]
  set DEL1 [ create_bd_port -dir O -from 7 -to 0 -type data DEL1 ]
  set DEL2 [ create_bd_port -dir O -from 7 -to 0 -type data DEL2 ]
  set DEL3 [ create_bd_port -dir O -from 7 -to 0 -type data DEL3 ]
  set DELT [ create_bd_port -dir O -from 7 -to 0 -type data DELT ]
  ...
  connect_bd_net -net TT_DETECTOR_0_DEBUG0 [get_bd_ports DEBUG0] [get_bd_pins TT_DETECTOR_0/DEBUG0]
  connect_bd_net -net TT_DETECTOR_0_DEBUG1 [get_bd_ports DEBUG1] [get_bd_pins TT_DETECTOR_0/DEBUG1]
  connect_bd_net -net TT_DETECTOR_0_DEBUG2 [get_bd_ports DEBUG2] [get_bd_pins TT_DETECTOR_0/DEBUG2]
