...
HD_PWD='D:/SInglePhotons/Vivado Projects/EXPERIMENTAL/SCS_TT16/SCS_TT16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SCS_TT_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SCS_TT_wrapper.tcl -notrace
