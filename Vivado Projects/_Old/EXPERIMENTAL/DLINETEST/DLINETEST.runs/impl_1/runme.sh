...
HD_PWD='D:/SInglePhotons/Vivado Projects/EXPERIMENTAL/DLINETEST/DLINETEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tdc_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tdc_ctrl.tcl -notrace
