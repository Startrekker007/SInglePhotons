...
HD_PWD='D:/SInglePhotons/Vivado Projects/DD_TEST_OV/DD_TEST_OV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DD_TEST_OV_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DD_TEST_OV_wrapper.tcl
