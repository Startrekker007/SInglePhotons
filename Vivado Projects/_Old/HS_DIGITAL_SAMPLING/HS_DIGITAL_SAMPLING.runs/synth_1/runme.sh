...
HD_PWD='C:/VivadoProj/HS_DIGITAL_SAMPLING/HS_DIGITAL_SAMPLING.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HS_SAMPLER_OVERLAY_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HS_SAMPLER_OVERLAY_wrapper.tcl
