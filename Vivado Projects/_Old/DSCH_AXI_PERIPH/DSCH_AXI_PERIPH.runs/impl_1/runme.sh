...
HD_PWD='D:/SInglePhotons/Vivado Projects/DSCH_AXI_PERIPH/DSCH_AXI_PERIPH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSCH_AXI_PERIPH_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSCH_AXI_PERIPH_wrapper.tcl -notrace
