...
################################################################
# This is a generated script based on design: DSCH_AXI_PERIPH
#
...
# source DSCH_AXI_PERIPH_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# IDELAY_CTRL_WRAPPER, Temptest
...
set design_name DSCH_AXI_PERIPH
...
proc create_root_design { parentCell } {
  ...
  # Create instance: DSCH_BD_wrapper_0, and set properties
  set DSCH_BD_wrapper_0 [ create_bd_cell -type ip -vlnv cri.nz:user:DSCH_BD_wrapper:1.0 DSCH_BD_wrapper_0 ]
  ...
  # Create instance: Temptest_0, and set properties
  set block_name Temptest
  set block_cell_name Temptest_0
  if { [catch {set Temptest_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Temptest_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net DSCH_BD_wrapper_0_drdy [get_bd_pins DSCH_BD_wrapper_0/drdy] [get_bd_pins UTIL/gpio2_io_i]
  connect_bd_net -net DSCH_BD_wrapper_0_edelay [get_bd_pins DSCH_BD_wrapper_0/edelay] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net DSCH_BD_wrapper_0_iretime [get_bd_pins DATA/gpio_io_i] [get_bd_pins DSCH_BD_wrapper_0/iretime]
  connect_bd_net -net DSCH_BD_wrapper_0_sdelay [get_bd_pins DSCH_BD_wrapper_0/sdelay] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net IDATA_1 [get_bd_ports IDATA] [get_bd_pins Temptest_0/INP]
  connect_bd_net -net Temptest_0_OUTP [get_bd_pins DSCH_BD_wrapper_0/IDATA] [get_bd_pins Temptest_0/OUTP]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins DSCH_BD_wrapper_0/resetn] [get_bd_pins UTIL/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins IDELAY_CTRL_WRAPPER_0/REF_CLK] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DATA/s_axi_aclk] [get_bd_pins UTIL/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ref_clk/clk_in1] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins IDELAY_CTRL_WRAPPER_0/RESETn] [get_bd_pins Temptest_0/EN] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins ref_clk/resetn] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net ref_clk_clk_out1 [get_bd_pins DSCH_BD_wrapper_0/MCLK] [get_bd_pins ref_clk/clk_out1]
