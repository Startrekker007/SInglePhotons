...
#
# Generated by export_simulation on Fri Nov 29 13:26:37 +1300 2019
#
################################################################################
...
'-reset_run' switch to the './C_COUNTER_INT.sh' script.

./C_COUNTER_INT.sh -reset_run
...
./C_COUNTER_INT.sh -noclean_files

For more information on the script, please type './C_COUNTER_INT.sh -help'.
