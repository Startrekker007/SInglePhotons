...
HD_PWD='D:/SInglePhotons/Vivado Projects/Pulse_Gen/Pulse_Gen.runs/C_COUNTER_INT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C_COUNTER_INT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C_COUNTER_INT.tcl
