...
#
# Generated by export_simulation on Thu Dec 19 12:06:18 +1300 2019
#
################################################################################
...
'-reset_run' switch to the './ph_ctr.sh' script.
...
./ph_ctr.sh -noclean_files

For more information on the script, please type './ph_ctr.sh -help'.
