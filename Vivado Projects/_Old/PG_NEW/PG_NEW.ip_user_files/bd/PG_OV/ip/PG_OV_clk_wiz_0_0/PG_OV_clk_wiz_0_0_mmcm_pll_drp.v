...
module PG_OV_clk_wiz_0_0_mmcm_drp
   #(
      //***********************************************************************
      ...
      input [31:0] S2_CLKFBOUT_PHASE ,//        , // 0,
      ...
      input [31:0] S2_CLKOUT0_PHASE          , 
      input [31:0] S2_CLKOUT0_DUTY           , 
      input [9:0] S2_CLKOUT0_FRAC          , 
      input        S2_CLKOUT0_FRAC_EN       ,
      
      input [7:0] S2_CLKOUT1_DIVIDE         ,
      input [31:0] S2_CLKOUT1_PHASE          , 
      input [31:0] S2_CLKOUT1_DUTY           , 
      
      input [7:0] S2_CLKOUT2_DIVIDE         ,
      input [31:0] S2_CLKOUT2_PHASE          , 
      input [31:0] S2_CLKOUT2_DUTY           , 
      
      input [7:0] S2_CLKOUT3_DIVIDE         ,
      input [31:0] S2_CLKOUT3_PHASE          , 
      input [31:0] S2_CLKOUT3_DUTY           , 
      
      input [7:0] S2_CLKOUT4_DIVIDE         ,
      input [31:0] S2_CLKOUT4_PHASE          , 
      input [31:0] S2_CLKOUT4_DUTY           , 
      
      input [7:0] S2_CLKOUT5_DIVIDE         ,
      input [31:0] S2_CLKOUT5_PHASE          , 
      input [31:0] S2_CLKOUT5_DUTY           , 
      
      input [7:0] S2_CLKOUT6_DIVIDE         ,
      input [31:0] S2_CLKOUT6_PHASE          , 
      input [31:0] S2_CLKOUT6_DUTY           , 
      input             LOAD,
   ...
   wire [37:0] S2_CLKFBOUT       = 
      mmcm_pll_count_calc(S2_CLKFBOUT_MULT, S2_CLKFBOUT_PHASE, 50000);
   ...
   wire [37:0] S2_CLKOUT0        = 
      mmcm_pll_count_calc(S2_CLKOUT0_DIVIDE, S2_CLKOUT0_PHASE, S2_CLKOUT0_DUTY);
   ...
   wire [37:0] S2_CLKOUT1        = 
      mmcm_pll_count_calc(S2_CLKOUT1_DIVIDE, S2_CLKOUT1_PHASE, S2_CLKOUT1_DUTY);
         
   wire [37:0] S2_CLKOUT2        = 
      mmcm_pll_count_calc(S2_CLKOUT2_DIVIDE, S2_CLKOUT2_PHASE, S2_CLKOUT2_DUTY);
         
   wire [37:0] S2_CLKOUT3        = 
      mmcm_pll_count_calc(S2_CLKOUT3_DIVIDE, S2_CLKOUT3_PHASE, S2_CLKOUT3_DUTY);
         
   wire [37:0] S2_CLKOUT4        = 
      mmcm_pll_count_calc(S2_CLKOUT4_DIVIDE, S2_CLKOUT4_PHASE, S2_CLKOUT4_DUTY);
         
   wire [37:0] S2_CLKOUT5        = 
      mmcm_pll_count_calc(S2_CLKOUT5_DIVIDE, S2_CLKOUT5_PHASE, S2_CLKOUT5_DUTY);
         
   wire [37:0] S2_CLKOUT6        = 
      mmcm_pll_count_calc(S2_CLKOUT6_DIVIDE, S2_CLKOUT6_PHASE, S2_CLKOUT6_DUTY);
   initial begin
