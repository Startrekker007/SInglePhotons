...
HD_PWD='D:/SInglePhotons/Vivado Projects/TT_OVERLAY/TT_OVERLAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TT_OV_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TT_OV_wrapper.tcl -notrace
