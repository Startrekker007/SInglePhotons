...
HD_PWD='D:/SInglePhotons/Vivado Projects/TT_OVERLAY/TT_OVERLAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TT_OV_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TT_OV_wrapper.tcl
