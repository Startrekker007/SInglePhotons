...
architecture STRUCTURE of DDR_EDGE_DETECT is
  ...
  attribute X_INTERFACE_PARAMETER of MCLK : signal is "XIL_INTERFACENAME CLK.MCLK, CLK_DOMAIN DDR_EDGE_DETECT_MCLK, FREQ_HZ 500000000, INSERT_VIP 0, PHASE 0.000";
...
DDR_EDGE_0: component DDR_EDGE_DETECT_DDR_EDGE_0_0
     port map (
      DRDY => DDR_EDGE_0_DRDY,
      IDATA(1 downto 0) => DDR_WRAPPER_0_ODATA(1 downto 0),
      MCLK => Net,
      estate => DDR_EDGE_0_estate,
      resetn => RESETN_1,
      sstate => DDR_EDGE_0_sstate,
...
DDR_WRAPPER_0: component DDR_EDGE_DETECT_DDR_WRAPPER_0_0
     port map (
      DDR_CLK => Net,
      DDR_DATA => DDR_DATA_1,
