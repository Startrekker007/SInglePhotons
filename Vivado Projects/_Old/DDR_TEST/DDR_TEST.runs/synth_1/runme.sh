...
HD_PWD='D:/SInglePhotons/Vivado Projects/DDR_TEST/DDR_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR_TEST.tcl
