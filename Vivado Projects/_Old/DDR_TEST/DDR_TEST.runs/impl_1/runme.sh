...
HD_PWD='D:/SInglePhotons/Vivado Projects/DDR_TEST/DDR_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR_TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDR_TEST.tcl -notrace
