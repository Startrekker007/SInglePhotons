...
HD_PWD='D:/SInglePhotons/Vivado Projects/DDR_CT_TEST_OV/DDR_CT_TEST_OV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR_CT_TEST_OV_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR_CT_TEST_OV_wrapper.tcl
