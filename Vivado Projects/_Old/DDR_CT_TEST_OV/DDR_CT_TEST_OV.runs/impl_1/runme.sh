...
HD_PWD='D:/SInglePhotons/Vivado Projects/DDR_CT_TEST_OV/DDR_CT_TEST_OV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR_CT_TEST_OV_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDR_CT_TEST_OV_wrapper.tcl -notrace
