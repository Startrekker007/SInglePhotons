...
entity SDDR_TT_M is
  ...
  attribute CORE_GENERATION_INFO of SDDR_TT_M : entity is "SDDR_TT_M,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SDDR_TT_M,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}";
...
architecture STRUCTURE of SDDR_TT_M is
  ...
  component SDDR_TT_M_xlconcat_0_0 is
  port (
  ...
  end component SDDR_TT_M_xlconcat_0_0;
  component SDDR_TT_M_TT_SLICER_0_0 is
  port (
  ...
  end component SDDR_TT_M_TT_SLICER_0_0;
  ...
  signal TT_SLICER_0_O0 : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal TT_SLICER_0_O1 : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal TT_SLICER_0_O2 : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal TT_SLICER_0_O3 : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal TT_SLICER_0_O4 : STD_LOGIC_VECTOR ( 3 downto 0 );
...
SDDR_TT_0: component SDDR_TT_M_SDDR_TT_0_0
     port map (
      ...
      D3(7 downto 0) => SDDR_TT_0_D3(7 downto 0),
      D4(7 downto 0) => SDDR_TT_0_D4(7 downto 0),
      DDR_T0(3 downto 0) => TT_SLICER_0_O0(3 downto 0),
      DDR_T1(3 downto 0) => TT_SLICER_0_O1(3 downto 0),
      DDR_T2(3 downto 0) => TT_SLICER_0_O2(3 downto 0),
      DDR_T3(3 downto 0) => TT_SLICER_0_O3(3 downto 0),
      DDR_T4(3 downto 0) => TT_SLICER_0_O4(3 downto 0),
      DRDY => SDDR_TT_0_DRDY,
      MCLK => MCLK_1,
      RESETN => resetn_1,
...
TT_SLICER_0: component SDDR_TT_M_TT_SLICER_0_0
     port map (
      I_DATA(19 downto 0) => selectio_wiz_0_data_in_to_device(19 downto 0),
      O0(3 downto 0) => TT_SLICER_0_O0(3 downto 0),
      O1(3 downto 0) => TT_SLICER_0_O1(3 downto 0),
      O2(3 downto 0) => TT_SLICER_0_O2(3 downto 0),
      O3(3 downto 0) => TT_SLICER_0_O3(3 downto 0),
      O4(3 downto 0) => TT_SLICER_0_O4(3 downto 0)
    );
...
xlconcat_0: component SDDR_TT_M_xlconcat_0_0
     port map (
      In0(0) => T0_1,
      In1(0) => T1_1,
      In2(0) => T2_1,
