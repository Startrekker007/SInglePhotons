...
HD_PWD='D:/SInglePhotons/Vivado Projects/TIME_TAG_N/TIME_TAG_N.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TIME_TAG_M.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TIME_TAG_M.tcl
