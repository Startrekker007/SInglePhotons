...
HD_PWD='D:/SInglePhotons/Vivado Projects/PG_OVERLAY/PG_OVERLAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PG_OV_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PG_OV_wrapper.tcl
