...
HD_PWD='D:/SInglePhotons/Vivado Projects/SCS_CT_OV/SCS_CT_OV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SCS_CT_OV_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SCS_CT_OV_wrapper.tcl -notrace
