...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set COUNT [ create_bd_port -dir O -from 31 -to 0 COUNT ]
  ...
  connect_bd_net -net EN_1 [get_bd_ports EN] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net MCLK_1 [get_bd_ports MCLK] [get_bd_pins CTR_CTL_0/CLK]
  connect_bd_net -net RST_1 [get_bd_ports RST] [get_bd_pins CTR_CTL_0/RST]
  connect_bd_net -net SIG_1 [get_bd_ports SIG] [get_bd_pins CTR_CTL_0/P_SIG_IN]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_ports COUNT] [get_bd_pins c_counter_binary_0/Q]
