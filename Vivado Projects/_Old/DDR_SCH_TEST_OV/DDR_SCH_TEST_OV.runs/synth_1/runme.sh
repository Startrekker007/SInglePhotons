...
HD_PWD='D:/SInglePhotons/Vivado Projects/DDR_SCH_TEST_OV/DDR_SCH_TEST_OV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR_SCH_TEST_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR_SCH_TEST_wrapper.tcl
