...
HD_PWD='D:/SInglePhotons/Vivado Projects/SCS_ST_TEST/SCS_ST_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCS_ST_TEST_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCS_ST_TEST_wrapper.tcl
