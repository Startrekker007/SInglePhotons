...
HD_PWD='D:/SInglePhotons/Vivado Projects/SCS_ST_TEST/SCS_ST_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SCS_ST_TEST_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SCS_ST_TEST_wrapper.tcl -notrace
