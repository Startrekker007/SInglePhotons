...
#
# Generated by export_simulation on Wed Jan 29 12:31:00 +1300 2020
#
################################################################################
...
'-reset_run' switch to the './ST_OS.sh' script.
...
./ST_OS.sh -noclean_files

For more information on the script, please type './ST_OS.sh -help'.
