...
HD_PWD='D:/SInglePhotons/Vivado Projects/SERDES_OVERSAMPLE/ST_TEST/ST_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ST_TEST_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ST_TEST_wrapper.tcl -notrace
