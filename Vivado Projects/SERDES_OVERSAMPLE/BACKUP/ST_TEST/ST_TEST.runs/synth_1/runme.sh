...
HD_PWD='D:/SInglePhotons/Vivado Projects/SERDES_OVERSAMPLE/ST_TEST/ST_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ST_TEST_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ST_TEST_wrapper.tcl
