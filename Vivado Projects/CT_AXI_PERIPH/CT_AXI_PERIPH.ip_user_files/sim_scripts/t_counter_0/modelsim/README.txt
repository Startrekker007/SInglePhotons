...
#
# Generated by export_simulation on Wed Dec 04 15:25:08 +1300 2019
#
################################################################################
...
'-reset_run' switch to the './t_counter_0.sh' script.

./t_counter_0.sh -reset_run
...
./t_counter_0.sh -noclean_files

For more information on the script, please type './t_counter_0.sh -help'.
