...
HD_PWD='D:/SInglePhotons/Vivado Projects/DELAYLINE_TEST/DELAYLINE_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DELAYLINE_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DELAYLINE_wrapper.tcl
