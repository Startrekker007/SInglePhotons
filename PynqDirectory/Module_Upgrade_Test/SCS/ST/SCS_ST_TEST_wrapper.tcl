...
################################################################
# This is a generated script based on design: SCS_ST_TEST
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net CLOCK_EXPAND_0_SCS_CLKS [get_bd_pins CLOCK_EXPAND_0/SCS_CLKS] [get_bd_pins SCS_ST_0/SCS_CLKS]
  connect_bd_net -net IDATA_1 [get_bd_ports IDATA] [get_bd_pins SCS_ST_0/IDATA]
  connect_bd_net -net SCS_ST_0_DRDY [get_bd_pins SCS_ST_0/DRDY] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net SCS_ST_0_TIME_DATA [get_bd_pins DATA/gpio_io_i] [get_bd_pins SCS_ST_0/TIME_DATA]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins SCS_ST_0/RESETN] [get_bd_pins UTIL/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins SCS_ST_0/MCLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins xlconcat_1/In0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UTIL/S_AXI/Reg] SEG_axi_gpio_0_Reg
