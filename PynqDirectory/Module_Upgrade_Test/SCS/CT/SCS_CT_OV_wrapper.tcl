...
################################################################
# This is a generated script based on design: SCS_CT_OV
#
...
cri.nz:user:SCS_CT_wrapper:1.0\
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net SCS_CT_wrapper_0_TDATA [get_bd_pins DATA/gpio_io_i] [get_bd_pins SCS_CT_wrapper_0/TDATA]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins SCS_CT_wrapper_0/FSEL] [get_bd_pins UTIL/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins SCS_CT_wrapper_0/resetn] [get_bd_pins UTIL/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins SCS_CT_wrapper_0/CLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins xlconcat_1/In0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UTIL/S_AXI/Reg] SEG_axi_gpio_0_Reg1
