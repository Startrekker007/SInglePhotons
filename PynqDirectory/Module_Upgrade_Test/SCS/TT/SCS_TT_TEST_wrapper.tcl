...
################################################################
# This is a generated script based on design: SCS_TT_TEST
#
...
cri.nz:user:SCS_TT_wrapper:1.0\
...
proc create_root_design { parentCell } {
  ...
  set T2 [ create_bd_port -dir I -type data T2 ]
  set T3 [ create_bd_port -dir I -type data T3 ]
  set T4 [ create_bd_port -dir I -type data T4 ]
  ...
  # Create instance: DATA_UTIL, and set properties
  set DATA_UTIL [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 DATA_UTIL ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
   CONFIG.C_ALL_INPUTS_2 {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins UTIL/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net SCS_TT_wrapper_0_DELT [get_bd_pins SCS_TT_wrapper_0/DELT] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net SCS_TT_wrapper_0_DRDY [get_bd_pins SCS_TT_wrapper_0/DRDY] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net SCS_TT_wrapper_0_LISTENING [get_bd_ports LISTENING] [get_bd_pins SCS_TT_wrapper_0/LISTENING]
  connect_bd_net -net SCS_TT_wrapper_0_T1 [get_bd_pins DATA0/gpio_io_i] [get_bd_pins SCS_TT_wrapper_0/T1]
  connect_bd_net -net SCS_TT_wrapper_0_T2 [get_bd_pins DATA0/gpio2_io_i] [get_bd_pins SCS_TT_wrapper_0/T2]
  connect_bd_net -net SCS_TT_wrapper_0_T3 [get_bd_pins DATA1/gpio_io_i] [get_bd_pins SCS_TT_wrapper_0/T3]
  connect_bd_net -net SCS_TT_wrapper_0_T4 [get_bd_pins DATA1/gpio2_io_i] [get_bd_pins SCS_TT_wrapper_0/T4]
  connect_bd_net -net SCS_TT_wrapper_0_TIMEOUTS [get_bd_pins SCS_TT_wrapper_0/TIMEOUTS] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net SCS_TT_wrapper_0_WAITING [get_bd_ports WAITING] [get_bd_pins SCS_TT_wrapper_0/WAITING]
  connect_bd_net -net T0_1 [get_bd_ports T0] [get_bd_pins SCS_TT_wrapper_0/T0]
  connect_bd_net -net T1_1 [get_bd_ports T1] [get_bd_pins SCS_TT_wrapper_0/CH0]
  connect_bd_net -net T2_1 [get_bd_ports T2] [get_bd_pins SCS_TT_wrapper_0/CH1]
  connect_bd_net -net T3_1 [get_bd_ports T3] [get_bd_pins SCS_TT_wrapper_0/CH2]
  connect_bd_net -net T4_1 [get_bd_ports T4] [get_bd_pins SCS_TT_wrapper_0/CH3]
  connect_bd_net -net UTIL_gpio2_io_o [get_bd_pins SCS_TT_wrapper_0/TIMEOUT] [get_bd_pins UTIL/gpio2_io_o]
  connect_bd_net -net UTIL_gpio_io_o [get_bd_pins SCS_TT_wrapper_0/resetn] [get_bd_pins UTIL/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins SCS_TT_wrapper_0/MCLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins xlconcat_2/In0]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins xlconcat_2/In1]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins xlconcat_2/In2]
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins clk_wiz_0/clk_out4] [get_bd_pins xlconcat_2/In3]
  connect_bd_net -net clk_wiz_0_clk_out5 [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins xlconcat_2/In4]
