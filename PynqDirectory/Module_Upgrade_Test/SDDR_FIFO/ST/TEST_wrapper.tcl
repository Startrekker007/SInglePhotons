...
proc create_root_design { parentCell } {
  ...
  set status [ create_bd_port -dir O -from 1 -to 0 -type data status ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins SDDR_AXI_ST_wrapper_0/ST_DATA] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins SDDR_AXI_ST_wrapper_0/ST_UTIL] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net ISERDES_B_0_data_in_to_device [get_bd_pins ISERDES_B_0/data_in_to_device] [get_bd_pins SDDR_AXI_ST_wrapper_0/T1]
  connect_bd_net -net SDDR_AXI_ST_wrapper_0_armed [get_bd_pins SDDR_AXI_ST_wrapper_0/armed] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net SDDR_AXI_ST_wrapper_0_waiting [get_bd_pins SDDR_AXI_ST_wrapper_0/waiting] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins SDDR_AXI_ST_wrapper_0/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins ISERDES_B_0/io_reset] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconcat_0_dout [get_bd_ports status] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins ISERDES_B_0/bitslip] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SDDR_AXI_ST_wrapper_0/ST_DATA/reg0] SEG_SDDR_AXI_ST_wrapper_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SDDR_AXI_ST_wrapper_0/ST_UTIL/reg0] SEG_SDDR_AXI_ST_wrapper_0_reg02
