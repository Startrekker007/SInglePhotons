...
################################################################
# This is a generated script based on design: DDR_SCH_TEST
#
...
# source DDR_SCH_TEST_script.tcl
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
cri.nz:user:DDR_EDGE_DETECT_wrapper:1.0\
cri.nz:user:IODELAY_BLK_wrapper:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DDR_DATA [ create_bd_port -dir I -type data DDR_DATA ]

  # Create instance: DDR_EDGE_DETECT_wrap_0, and set properties
  set DDR_EDGE_DETECT_wrap_0 [ create_bd_cell -type ip -vlnv cri.nz:user:DDR_EDGE_DETECT_wrapper:1.0 DDR_EDGE_DETECT_wrap_0 ]
  ...
  connect_bd_net -net DDR_DATA_1 [get_bd_ports DDR_DATA] [get_bd_pins IODELAY_BLK_wrapper_0/IDATA]
  connect_bd_net -net DDR_EDGE_DETECT_wrap_0_DRDY [get_bd_pins DDR_EDGE_DETECT_wrap_0/DRDY] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net DDR_EDGE_DETECT_wrap_0_ESTATE [get_bd_pins DDR_EDGE_DETECT_wrap_0/ESTATE] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net DDR_EDGE_DETECT_wrap_0_SSTATE [get_bd_pins DDR_EDGE_DETECT_wrap_0/SSTATE] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net DDR_EDGE_DETECT_wrap_0_TIME_DATA [get_bd_pins DDR_EDGE_DETECT_wrap_0/TIME_DATA] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net DDR_WRAPPER_0_ODATA [get_bd_pins DDR_EDGE_DETECT_wrap_0/DDR_IDATA] [get_bd_pins DDR_WRAPPER_0/ODATA]
  connect_bd_net -net IODELAY_BLK_wrapper_0_ODATA [get_bd_pins DDR_WRAPPER_0/DDR_DATA] [get_bd_pins IODELAY_BLK_wrapper_0/ODATA]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins DDR_EDGE_DETECT_wrap_0/RESETN] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins IODELAY_BLK_wrapper_0/RCLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins util_idelay_ctrl_0/ref_clk]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins DDR_EDGE_DETECT_wrap_0/MCLK] [get_bd_pins DDR_WRAPPER_0/DDR_CLK] [get_bd_pins IODELAY_BLK_wrapper_0/MCLK] [get_bd_pins clk_wiz_1/clk_out1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins IODELAY_BLK_wrapper_0/resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins clk_wiz_1/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins IODELAY_BLK_wrapper_0/STAGE] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins IODELAY_BLK_wrapper_0/TAP] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins IODELAY_BLK_wrapper_0/LD] [get_bd_pins xlconstant_2/dout]
